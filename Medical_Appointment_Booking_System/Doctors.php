...
<section>
  ...
  <form method="post">
    ...
    <input type="text" id="sp" name="sp" required><br><br>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
      $stmt = $connection->prepare("INSERT INTO doctors(doctor_id, doctor_name, specialty, phone_number) VALUES (?, ?, ?, ?)");
      $stmt->bind_param("isss", $did, $dn, $sp, $tlphn);
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<tr>
                ...
                <td><a style='padding:4px' href='delete_Doctors.php?doctor_id=$did'>Delete</a></td> 
                <td><a style='padding:4px' href='update_Doctors.php?doctor_id=$did'>Update</a></td> 
            </tr>";
        }
    } else {
