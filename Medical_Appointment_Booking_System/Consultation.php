...
<body>
<header><center>
    <h1>Consultation Page</h1></center>
  </header>
...
<section>
  ...
  <!-- Form to add a new consultation -->
  <form method="post">
    <label for="consultation_id">Consultation ID:</label>
    <input type="number" id="consultation_id" name="consultation_id"><br><br>
    ...
    <input type="text" id="consultation_time" name="consultation_time" required><br><br>

    <label for="consultation_notes">Consultation Notes:</label>
    <input type="text" id="consultation_notes" name="consultation_notes" required><br><br>

    <input type="submit" name="add_consultation" value="Insert"><br><br>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $stmt = $connection->prepare("INSERT INTO Consultation(consultation_id, appointment_id, doctor_id, consultation_date, consultation_time, consultation_notes  ) VALUES (?, ?, ?, ?, ?, ?)");
      $stmt->bind_param("isssss", $consultation_id, $appointment_id, $doctor_id, $consultation_date, $consultation_time, $consultation_notes );
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<tr>
                ...
                <td>" . $row['consultation_notes'] . "</td>

                
                <td><a style='padding:4px' href='delete_Consultation.php?consultation_id=$consultation_id'>Delete</a></td> 
                <td><a style='padding:4px' href='update_Consultation.php?consultation_id=$consultation_id'>Update</a></td> 
            </tr>";
        }
    } else {
