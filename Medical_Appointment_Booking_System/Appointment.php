...
<section>
  ...
  <form method="post">
    ...
    <input type="date" id="ad" name="ad" required><br><br>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $stmt = $connection->prepare("INSERT INTO appointments(appointment_id, patient_id, doctor_id, appointment_date, appointment_reason) VALUES (?, ?, ?, ?, ?)");
      $stmt->bind_param("iiiss", $aid, $pid, $did, $ad, $ar);
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<tr>
                ...
                <td><a style='padding:4px' href='delete_appointment.php?appointment_id=$aid'>Delete</a></td> 
                <td><a style='padding:4px' href='update_appointment.php?appointment_id=$aid'>Update</a></td> 
            </tr>";
        }
    } else {
